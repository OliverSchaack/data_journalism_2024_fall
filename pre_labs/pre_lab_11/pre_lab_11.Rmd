...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **The colums are split up by column and then by each Party group representtaives for the presidential race.**
...
**Task** Run the following code to extract the table we want, clean up the names and remove the total row. Look at the rename() function - what do you think the numbers 2 through 6 are referring to? **Each number stands for the selection of a candidate. So if someone chose Harris, it would register as 2, Trump would be 3, and so on and so forth.**
...
**Task** Run the following code in the gray-colored codeblock below to find the <li> tags. What does the output suggest about how many <ul> tags there are in the HTML source? **It suggest that there are 55 URL tags.**
...
**Task** Run the following code in the gray-colored codeblock below to find the text inside <li> tags. Describe the output: **The output is different categories along with different job occupations as well.**
...
### Task 11: Turn the contents of the <li> and <a> tags into a dataframe **Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **It gives a name and a URL**
