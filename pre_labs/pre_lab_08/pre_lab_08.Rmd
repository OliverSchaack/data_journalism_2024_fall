...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **24 rows 18 columns**
...
**we are creating a new md_voters with the data from the old md_voters file. We are mutating the column UNAF_DIFF so that in this new md_voters, that column represents each county by its difference in unaffiliated voters from 2022 to 2024. After this, we created a new file called maryland_top_counties using the new md_voters file that we just created. From there, we are arranging hte UNAF_DIFF column in desceing order and asking R studio to only display the County and and UNAF_DIFF columns. Lastly, the head function is used to only display a certain amount of rows per page, which in this case is 10, and typing out maryland_top_counties at the bottom enables R studio to display the code for us to see in addition to just running the code.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **I see a blank page with nothing on it.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **I see a bar chart now with information and X Y columns.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **I now see a bar chart in ascending order compared to before where the order was based on alphebtical order of the counties in Maryland.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **The X Y columns flipped so that now the County column is the Y column and the count column is the X column.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Nothing chagned from the last graph to this one.**
...
**Task** Run the following code. **Task**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **The background is a different color from above **
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **There is now a title for the graph and the font for the Counties in the Y column is larger.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **It's the total contributions of votes per date from 2022.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **This is the contributions per date except the X column is by Month and it is a line graph.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **This shows the contributions by week in 2022 instead of the month like it did above.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **This adjust the overall size of the graph and made it smaller.**
