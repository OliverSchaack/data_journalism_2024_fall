...
**Task** Run the following code and describe the dataframe it outputs. **It's every release organized by title and date published.**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **It shows each word within the list but does not show it everytime it appears.**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **The output is every single unique word that pops up.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **It's the count of each word that is used to show what words are used the most which is interesting to see to know what verbage is used the most.**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **It's the percent of the time a word is used in releases.**
...
**Task** Run the following code and describe the results. **Shows the percentage that the unique words are used.**
...
**Task** Run the following code and describe the results. **This shows the percentage that unique phrases are used.**
...
**Task** Run the following code and describe the results. **This shows the percentage of unique phrases that are used in 2024.**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **This shows unqiue words and the sentiment that accompanies it.**
