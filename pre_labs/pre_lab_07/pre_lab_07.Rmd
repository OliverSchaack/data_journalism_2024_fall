...
Is the difference between Calvert and Montgomery significant? **No, it is not signifcant because there is overlap between the two county's bars.**

Is the difference between Howard and everyone else significant? **Yes, the closest to Howard is is Calvert, and there is still no overlap. **
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **I'm just curious where they are geogrpahically in relation to each other. That would maybe help be able to understand trends in terms of significane when looking at the bar graphs.**
```{r}
md_zips_with_acs |>
