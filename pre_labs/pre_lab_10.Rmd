...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Ten columns exist that list the different types of precincts and political setup within each precinct.**
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **This is a comprehensive list of the different Prince George's County precincts giving very similar information to the previous data set above.**
...
**Task** Run the following code. Describe the output in the space below. **This is a map of all the different PG County precints with their actual geographical coordinates of each precinct.**
...
**Task** Run the following code. Describe the output in the space below. **It says that I have to "set `options(tigris_use_cache = TRUE" in order to enable caching of data.)**
...
**Task** Run the following code. Describe the output in the space below. **This is a list of counties on a national level that are organized similarly to how the PG precincts were.**
...
**Task** Run the following code. Describe the output in the space below. **This is just Maryland counties now instead of all counties.**
...
**Task** Run the following code. Describe the output in the space below. **Maryland counties broken down geographically by geographical coordinates.**
...
**Task** Run the following code. Describe the output in the space below. **This is both Md counties and PG precincts broken down by geographical location.**
...
**Task** Run the following code. Describe the output in the space below. **Turnout of voters in PG County organized by how they voted.**
...
**Task** Run the following code. Describe the output in the space below. **Voter turnout by precinct.**
...
**Task** Run the following code. Describe the output in the space below. **Eligible voters broken down by Maryland precinct.**
...
**Task** Run the following code. Describe the output in the space below. **Voters by Maryland county organized by party affiliation.**
...
**Task** Run the following code. Describe the output in the space below. **Maryland counties organized in alphabetical order.**
...
**Task** Run the following code. Describe the output in the space below. **Maryland county populations in 2022 organized by GEOID.**
...
**Task** Run the following code. Describe the output in the space below. **MD county population organized by party affiliation and in alphabetical order.**
...
**Task** Run the following code. Describe the output in the space below. **MD counties but with no GEOID.**
...
**Task** Run the following code. Describe the output in the space below. **MD counties organized by party affiliation per country among voters.**
...
**Task** Run the following code. Describe the output in the space below. **it shows county, population, and geometry.**
...
**Task** Run the following code. Describe the output in the space below. **This shows how my voters per 10,000 people within a Maryland county.**
...
**Task** Run the following code. Describe the output in the space below. **Graphic of the state of Maryland broken down by county and showing the amount of voters per 10,000 people within each county.**
...
**Task** Run the following code. Describe the output in the space below. **Same as the previous graphic but with different colors.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Middle part of the state has consistent counties with between 7,000-7,500 voters per 10,000 people.**
...
**Task** Run the following code. Describe the output in the space below. **Shows voter affiliation but also includes percentage of unaffiliated voters per 10,000 people in each county.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see, especially on the ends of the scale? **Number of unaffilaited voters within each Maryland county per 10,000 people.**
