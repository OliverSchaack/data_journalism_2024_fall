...
**131,395 observations and 24 variables**
...
In the space below, write the data type for the "last_name" column and the "amount" columns (it's in light gray, offset by \< \>). Also offer your best guess as to what the "last_name" column and the "amount" column represent. **"Last name" is chr data and "amount" is dbl data. I think the last name data is the last name of people in the data set and amount is population in each city to the tens of thousands**
...
**I think that this is showing the number of contributions, or people, per county that are a part of the total dataset and I think that it is to the nearest 10 thousand place.**
...
**the "count_contribs" per date are much larger in this data set compared to the previous.**
...
**This gave different ways that the data can be visually presented as well as the data itself changing as wellr**
...
**This gave the total amount per dataset unlike the previous datasets**
...
**This gave the mean and median amount unlike the previous datasets**
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **This gave all the previous columns of data from before with the previous datasets but also included a minimum and maximum amount**
