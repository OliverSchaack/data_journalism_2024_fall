...
* **Analysis summary**: When filtering the data, 229 of the respondents chose 5 on the survey, which has the answer as they wanted to vote but had work/ other obligations or forgot. Furthermore, in question 19 asks respondents what they think would make it easier for them to vote. I chose the responses that have to do with automatically being registered to vote and automatically recieving a mail- in ballot which had thousands of respondents say this would mkae voting a lot more appealing for them. Comparing these different answers shows what would make voting more easier for those who might not know about mail-in deadlines.
